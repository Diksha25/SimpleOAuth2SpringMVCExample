 ...
 */
package org.springsecurity.oauth2.controller.oauth;
...
import org.springsecurity.oauth2.oauth.OAuth2UserApprovalHandler;
...
//	@Autowired
	private OAuth2UserApprovalHandler	userApprovalHandler;
	...
	private void checkResourceOwner( String user , Principal principal )
	{
		if ( principal instanceof OAuth2Authentication )
		{
			...
			if ( !authentication.isClientOnly() && !user.equals( principal
					.getName() ) )
			{
	 ...
	 *            the userApprovalHandler to set
	 */
	public void setUserApprovalHandler( OAuth2UserApprovalHandler userApprovalHandler )
	{
